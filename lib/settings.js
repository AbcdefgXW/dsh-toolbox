...
/** 数值型开关单独处理。 */
const NUMBER_KEYS = new Set(["trashRetentionDays", "collapseUserThreshold", "scheduleInterval", "searchCacheSeconds"]);

/** 文本型开关（提示语等）。 */
const STRING_KEYS = new Set(["schedulePrompt", "scheduleCron", "scheduleTarget", "scheduleCronTarget", "scheduleCronPrompt", "embedBaseUrl", "embedApiKey", "embedModel"]);
