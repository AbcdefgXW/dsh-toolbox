...
export const TOOL_SWITCHES = [
  ...
  },
  {
    key: "lanBind",
    label: "局域网访问（LAN 绑定）",
    description: "实验性：把 dsh web 重绑到 0.0.0.0，局域网设备可访问（默认关，需重启生效）。⚠️ 0.0.0.0 = 局域网任何设备可驱动 agent（含 shell），建议防火墙限制 3080；非本机访问特权 API（设置/凭证）需当前 dsh 版本的 trustedHosts 实际生效，若返回 403 属官方安全拒绝（不影响其他功能）",
    hot: false,
    default: true,
  },
  {
